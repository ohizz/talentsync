...
export const Header = () => {
 ...
 <header className="bg-slate-200 border rounded-full px-6 md:px-4 py-[8px] flex justify-between items-center">
...
<div>
  <div className="mt-24 flex gap-x-10">
            <div className="mt-7 text-left flex items-start flex-col w-1/2 gap-y-10">
                ...
                <div className='flex gap-x-2'>
                    <button className="bg-blue-700 text-white border-slate-500 px-3 py-2 text-black border rounded-full ">start your free trial</button>
              <div className='flex justify-center gap-x-2 items-center'>
              <img src={ai }/> 
              <button className='text-blue-700 font-bold'> Discover AI assistant</button>
              </div>
                </div>
                <div>
          ...
          <div className='flex justify-between items-center  mt-10 mb-32 mx-auto'>
            <img className='w-32' src={shopify} />
            <img className='w-32' src={coinbase} />
            <img className='w-32' src={dropbox} />
            <img className='w-32' src={intercom} />
            <img className='w-32' src={marvel} />
            <img className='w-32' src={automattic}/>
          </div>
            </div>
        </div>
    </div>
