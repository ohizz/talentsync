...
export const Mockup = () => {
    return (
        ...
        <button className="bg-white border-slate-500  text-black border rounded-full px-2">Take to sales</button>
        <button  className="bg-blue-700 px-2 py-2 text-white border rounded-full ">sign up for free</button>
      </div> 
            </div>
