...
export const Middle = () => {
    return (
        <div className='max-w-6xl mx-auto px-2.5'>
            ...
            <div className='-mt-[20px] flex justify-center items-center gap-x-4 flex-wrap md:flex-nowrap flex-col-reverse md:flex-col'>
            <div className="text-left grid auto-rows-fr grid-cols-2 gap-10">
                    <div className=''>
